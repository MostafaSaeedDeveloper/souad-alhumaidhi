...
3. **المبادرات**: تم التحقق من ثلاث مبادرات خيرية/إنسانية عبر أكثر من مصدر صحفي مستقل يتفق على نفس التفاصيل (صحيفة البيان، صحيفة عكاظ، Wikirowad): إنشاء مركز حمد الحميضي وشيخة السديراوي الصحي بالشويخ، ترميم جامع العمري الكبير ببيروت، والمشروع التعليمي/السكني لرعاية نحو 3000 يتيم في لبنان. تم نشرها (`published`) مع الإشارة لمصدر كل مبادرة. أي مبادرة إضافية غير مؤكدة تُبقى كمسودة في لوحة الإدارة حتى التحقق منها.
